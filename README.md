...
* SGE_CaseControlAnalysis - Case-control analysis of BARD1 variants using the BRIDGES and CARRIERS breast cancer case-control cohorts. Output used in Fig. 3d and the BARD1_OddsRatios_table supplmentary table. **(Needs BRIDGES and CARRIERS data)**
...
* SGE_EditRate_BarPlot - Generates SGE target-facted bar plot showing editing rate generating useable reads across all targets and replicates (Extended Data Fig. 1a).
...
* SGE_PyMOL_BRCA1_ColorSurface - Generates colored space-filling models dispalying either minuimum or mean missense score at surface (Fig. 6d). **(Needs BRCA1 SGE file)**
