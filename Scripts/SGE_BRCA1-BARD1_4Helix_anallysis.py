...
#brca1_data['AApos'] = brca1_data['amino_acid_change'].transform(lambda x: x[1:-1])

#brca1_data = brca1_data.loc[(brca1_data['AApos'].astype(int).isin(brca1_helix_residues)) & (brca1_data['Consequence'] == 'missense_variant')]

print(bard1_data.head())